...
exports.createAdminSuggestionsHandler = createAdminSuggestionsHandler;
 ...
 */
function createAdminSuggestionsHandler(service, opts) {
    const { getAdmin } = opts;
    ...
    async function PUT(request) {
        ...
        try {
            ...
            if (error instanceof suggestion_service_1.SuggestionServiceError) {
                let statusCode = 400;
                if (error.code === suggestion_service_1.ERROR_CODES.NOT_FOUND)
                    statusCode = 404;
                else if (error.code === suggestion_service_1.ERROR_CODES.INVALID_STATUS)
                    statusCode = 400;
